...
const checks = [
  ...
  ['hair receives final downward micro-seat', /yOffsetMul:\s*0\.125/.test(attachmentFit) && /yOffsetMul:\s*0\.065/.test(attachmentFit) && /yOffsetMul:\s*0\.085/.test(attachmentFit)],
