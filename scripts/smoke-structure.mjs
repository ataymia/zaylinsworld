...
const checks = [
  ...
  ['hair receives only final downward micro-seat', /yOffsetMul:\s*0\.14/.test(attachmentFit) && /yOffsetMul:\s*0\.08/.test(attachmentFit) && /yOffsetMul:\s*0\.10/.test(attachmentFit)],
