...
export const STARTER_TOWN_ROUTES = freeze([
  ...
  route('dreamdrop-boulevard', 'Dreamdrop Boulevard', 'main', [
    [-900, -120], [-500, -120], [0, -120], [500, -120], [900, -120],
  ]),
  route('centre-avenue', 'Centre Avenue', 'main', [
    [0, -900], [0, -500], [0, 0], [0, 500], [0, 900],
  ]),
