...
export const INTERIOR_PREFABS = {
  ...
  block_supply_interior: {
    ...
    zones: [
      { pool: 'weapon_wall', at: { x: 0, z: -4 }, count: 6, along: 'wall', face: 'in', station: 'buy' },
      { pool: 'pistol_wall', at: { x: -4, z: 0 }, count: 5, along: 'wall', face: 'in', ry: Math.PI / 2, station: 'buy' },
      { pool: 'melee_rack', at: { x: 4, z: -2 }, count: 4, along: 'wall', face: 'in', ry: -Math.PI / 2, station: 'buy' },
      { pool: 'ammo_shelf', at: { x: -2, z: 3 }, count: 3, along: 'row' },
      { pool: 'upgrade_counter', at: { x: 1.5, z: 2.5 }, count: 1, station: 'upgrade' },
    ],
    stations: [
      { id: 'buy', at: { x: 0, z: -3 }, label: 'Browse weapons' },
  ...
  police_interior: {
    ...
    zones: [
      { pool: 'police_props', at: { x: 0, z: -3.5 }, count: 1, station: 'frontdesk' },
      { pool: 'classroom_board', at: { x: -4, z: -2 }, count: 1, station: 'academy' },
      { pool: 'office_desk', at: { x: 3, z: -1 }, count: 2, along: 'row' },
    ],
    stations: [
      { id: 'frontdesk', at: { x: 0, z: -2.8 }, label: 'Front desk' },
      { id: 'academy', at: { x: -4, z: -1.4 }, label: 'Police academy info' },
      { id: 'restricted', at: { x: 4, z: -4 }, label: 'Restricted (evidence)' },
    ],
    npcSpawns: [{ x: 0, z: -2.4, role: 'police' }, { x: -3, z: 0, role: 'police' }],
  },
  classroom_interior: {
    ...
    zones: [
      ...
      { pool: 'classroom_desk', at: { x: 0, z: 0 }, count: 6, along: 'grid', spacing: 2.0, station: 'study' },
    ],
