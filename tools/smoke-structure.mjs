...
const checks = [
  ...
  ['hair receives final down-and-back micro-seat', /yOffsetMul:\s*0\.135/.test(attachmentFit) && /yOffsetMul:\s*0\.075/.test(attachmentFit) && /yOffsetMul:\s*0\.095/.test(attachmentFit) && /zOffsetMul:\s*-0\.010/.test(attachmentFit)],
